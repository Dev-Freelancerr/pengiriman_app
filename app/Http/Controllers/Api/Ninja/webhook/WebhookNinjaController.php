    ...
    public function handledWebhookV2(Request $request) {
        try {
            ...
            if ($this->verifyWebhook($data, $hmacHeader)) {
                ...
                $signedBy = $payload['picked_up_information']['proof']['signed_by'] ?? null;
                ...
                $delivery_information_state = $payload['delivery_information']['state'];
                $delivery_information_left_in_safe_place = $payload['delivery_information']['left_in_safe_place'];
                $delivery_information_signedBy = $payload['delivery_information']['proof']['signed_by'] ?? null;
                ...
                $data_order = [
                    ...
                    'signed_by_contact' => $signedBy['contact'] ?? $delivery_information_signedBy['contact'],
                    'signed_by_name' => $signedBy['name'] ?? $delivery_information_signedBy['name'],
                    'signed_by_relationship' => $signedBy['relationship'] ?? $delivery_information_signedBy['relationship'],
