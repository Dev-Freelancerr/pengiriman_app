$(document).ready(function () {
    ...
    if ($('#choices-button').length > 0) {
        var element = $('#choices-button');
        var cityDropdown = $('#choices-city');
        var districtDropdown = $('#choices-district');
        var subdistrictDropdown = $('#choices-subdistrict');
        var postalcodeDropdown = $('#choices-postalcode');
