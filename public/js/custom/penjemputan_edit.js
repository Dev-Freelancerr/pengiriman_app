$(document).ready(function () {
    ...
    if ($('#choices-button2').length > 0) {
        var element = $('#choices-button2');
        var cityDropdown = $('#choices-city2');
        var districtDropdown = $('#choices-district2');
        var subdistrictDropdown = $('#choices-subdistrict2');
        var postalcodeDropdown = $('#choices-postalcode2');
